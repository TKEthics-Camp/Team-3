...
const meta={
  ...
  stick:{zh:['火柴人格斗 · 雷霆对决','跳跃后按拳发动飞踢；拳→扫发动残像连拳；扫→拳发动雷葬·草薙。支持三档 AI 与本地双人，受击时跳跃＋格挡可受身。','全屏火柴人格斗：挑战三档 AI 或本地双人，体验雷剑处决、残影冲击与破壁演出。','格斗 · AI / 本地双人'],en:['Stick Fighter · Thunder Duel','Press Punch after jumping to flying-kick; Punch→Sweep triggers the afterimage barrage; Sweep→Punch triggers Thunder Burial. Three AI levels and local PVP are supported.','Fullscreen stick fighting against three AI levels or a local player, with lightning executions, afterimages, and wall breaks.','Fighting · AI / Local PVP']},
