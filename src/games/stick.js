...
function initStickPvp(){
  ...
  const g={score:0,players:[player(1,250,'#49d9ff','#c8f7ff'),player(2,650,'#ff4f81','#ffd0de')],round:1,time:45,intro:2.4,roundPause:0,matchWinner:null,configOpen:false,listening:null,configNote:'',aiMode:stickSettings.mode==='ai',onlineMode:stickSettings.mode==='online',onlinePlayer:[1,2].includes(matchedPlayer)?matchedPlayer:stickSettings.onlinePlayer,aiLevel:stickSettings.level,aiThink:.3,aiPendingPunch:0,particles:[],rings:[],texts:[],teleports:[],barrages:[],lightning:[],shake:0,hitStop:0,ko:null,cameraZoom:1,cameraX:0,cameraY:0,screenFlash:0,cinematic:0,wallFlash:0,wallCracks:[0,0]};
